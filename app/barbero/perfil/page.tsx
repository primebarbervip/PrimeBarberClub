        ...
        {showPhotoMenu && (
          <div className="fixed inset-0 z-[110] flex items-end md:items-center justify-center">
            ...
            <motion.div
              ...
              className="relative w-full max-w-md bg-zinc-900 border border-zinc-800 rounded-t-3xl md:rounded-3xl p-8 z-[120] mx-4"
            >
              <div className="w-12 h-1.5 bg-zinc-800 rounded-full mx-auto mb-6 md:hidden" />
              <h3 className="text-lg font-bold mb-6 text-center">Opciones de Foto</h3>
              <div className="space-y-3">
                <button
                  onClick={() => window.open(perfil.img)}
                  className="w-full py-4 bg-zinc-800 hover:bg-zinc-700 rounded-xl flex items-center justify-center gap-3 font-semibold text-sm transition-all"
                >
                  <Eye size={18} />
                  Ver Foto Actual
                </button>
                <button
                  ...
                  className="w-full py-4 bg-zinc-800 hover:bg-zinc-700 rounded-xl flex items-center justify-center gap-3 font-semibold text-sm text-blue-400 transition-all"
                >
                  <RefreshCw size={18} />
                  Cambiar Imagen
                </button>
                <button
                  ...
                  className="w-full py-4 bg-red-500/10 hover:bg-red-500/20 rounded-xl flex items-center justify-center gap-3 font-semibold text-sm text-red-400 transition-all"
                >
                  <Trash2 size={18} />
                  Eliminar Foto
                </button>
                <button
                  onClick={() => setShowPhotoMenu(false)}
                  className="w-full mt-2 py-3 font-semibold text-xs text-zinc-500 hover:text-zinc-400 transition-colors"
                >
                  Cancelar
                </button>
              </div>
