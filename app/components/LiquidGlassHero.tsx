  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-[#0a0a0a]/70 md:bg-[#0a0a0a]/60" />
        <div className="absolute inset-0 bg-gradient-to-b from-[#0a0a0a]/85 md:from-[#0a0a0a]/80 via-transparent to-[#0a0a0a]/95 md:to-[#0a0a0a]/90" />
      </div>
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        <motion.h1
          ...
          className="text-5xl sm:text-6xl md:text-8xl lg:text-9xl font-extralight tracking-[0.3em] -mr-[0.3em] text-white drop-shadow-lg mb-6 text-balance"
        >
          PRIME
        </motion.h1>
        ...
        >
          ...
          <p className="text-white/40 text-sm md:text-base font-light max-w-md mx-auto leading-relaxed mb-12">
            Experiencia premium en cortes y estilos de vanguardia
          </p>
        </motion.div>
