...
export default function RegistroPage() {
  ...
  const isJefe = email.toLowerCase().trim() === 'cubasamuel852@gmail.com';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4 selection:bg-white selection:text-black relative overflow-hidden">
