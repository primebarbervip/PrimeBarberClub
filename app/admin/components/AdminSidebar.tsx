        ...
        <>
            ...
            <div className="md:hidden fixed top-6 right-6 z-50">
                <button
                    ...
                    className="p-3 bg-zinc-900 border border-zinc-800 rounded-full text-white shadow-xl active:scale-90 transition-all"
                >
                    <Menu size={24} />
                </button>
            </div>
                ...
                {isOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="fixed inset-y-0 right-0 z-50 w-[70%] bg-zinc-900/30 backdrop-blur-xl border-l border-white/10 p-6 flex flex-col md:hidden shadow-2xl"
                        >
            ...
            <motion.aside
                ...
                className="hidden md:flex fixed right-0 top-0 bottom-0 flex-col bg-zinc-900/30 backdrop-blur-xl border-l border-white/10 z-40 shadow-2xl overflow-hidden"
            >
                {/* HEADER: TOGGLE + TITLE */}
                <div className="h-20 flex items-center px-3 mb-2 shrink-0 border-b border-white/5">
                    <button
                    ...
                    <div className={`ml-3 overflow-hidden whitespace-nowrap transition-all duration-300 ${isExpanded ? "opacity-100" : "opacity-0"}`}>
                        ...
                        <p className="text-[10px] text-zinc-500 uppercase tracking-widest leading-none mt-1">Admin Panel</p>
                    </div>
                </div>
                ...
                <div className="p-4 border-t border-white/10 flex justify-center">
                    <button
                        onClick={handleLogout}
                        className={`flex items-center gap-2 text-red-500/80 hover:text-red-500 transition-colors ${isExpanded ? "w-full justify-start px-2" : "justify-center"
                            }`}
                        title="Cerrar Sesión"
                    >
                        <LogOut size={20} />
